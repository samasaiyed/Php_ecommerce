...
if(isset($uid))
{
	...
	$sel_product = "SELECT product.pid,product.category,product.product_name,product.brand,product.mrp,product.selling_price,product.qty,product.images,product.title,product.description,product.ingredients,product.howto,wishlist.uid,wishlist.pid from product  inner join wishlist on product.pid = wishlist.pid where wishlist.uid = '".$uid."' ";
...
<div style="text-align: center; font-weight: bold; margin-top: 5vw; font-size: 2vw; color: darkred; "> My Wishlist(<?php echo mysqli_num_rows($res1);?>) </div>
</div>
...
<div class="row"> 
    ...
    <div class="column">
        ...
        <div class="card">
        	...
        	<a href="Wishlist_delete.php?pid=<?php echo $row['pid'];?>">
          		<i style="font-size:1.1vw;float: right;overflow-y: hidden;" class="fa" title="Remove From Wishlist" >&#xf00d;</i>
        	</a>
