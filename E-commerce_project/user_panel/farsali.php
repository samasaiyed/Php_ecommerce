...
$sql = "select *from product where brand = 'FARSALI' && status = 1";
...
<div style="text-align: center; font-weight: bold; margin-top: 50px; font-size: 25px; color: darkred; "> Farsáli (<?php echo mysqli_num_rows($res);?>) </div>
</div>

<div class="slide" align="center">
                 <img src="image/Farsali/Farsali_slide.jpg">
