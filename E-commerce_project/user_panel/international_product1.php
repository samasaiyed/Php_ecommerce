...
$sql = "select *from product where brand in ('THE BALM','HUDA BEAUTY','CHARLOTTE TILBURY','FARSALI','FLOWER BEAUTY','LIME CRIME','MURAD','WISHFUL','ESTEE LAUDER') && status = 1";
...
<div style="text-align: center; font-weight: bold; margin-top: 50px; font-size: 25px; color: darkred; "> Must Have International products (<?php echo mysqli_num_rows($res);?>) </div>
</div>
