...
$sql = "select *from product where brand = 'KAY BEAUTY' && status = 1";
...
<div style="text-align: center; font-weight: bold; margin-top: 50px; font-size: 25px; color: darkred; "> Kay Beauty(<?php echo mysqli_num_rows($res);?>) </div>
</div>

<div class="slide" align="center">
                <img src="image/kay/key_slide1.jpg">
                <img src="image/kay/key_slide3.jpg">
                <img src="image/kay/key_slide2.jpg">
                <img src="image/kay/key_slide4.jpg">
