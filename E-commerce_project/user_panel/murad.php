...
$sql = "select *from product where brand = 'MURAD' && status = 1";
...
<div style="text-align: center; font-weight: bold; margin-top: 50px; font-size: 25px; color: darkred; "> Murad(<?php echo mysqli_num_rows($res);?>) </div>
</div>

<div class="slide" align="center">
                <img src="image/murad/murad_slide.jpg">
</div> 
