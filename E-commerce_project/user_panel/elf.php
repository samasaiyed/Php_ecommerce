...
$sql = "select *from product where brand = 'E.L.F' && status = 1";
...
<div style="text-align: center; font-weight: bold; margin-top: 50px; font-size: 25px; color: darkred; "> E.L.F Cosmatics (<?php echo mysqli_num_rows($res);?>) </div>
</div>

<div class="slide" align="center">
     <h2> This Just In: E.L.F. Cosmetics Is Now In India! </h2>
            <img src="image/elf/elf_1.jpg">
            <img src="image/elf/elf_3.jpg" width="550px" height="400px">
            <p> E.l.f. Cosmetics is all about their fundamentals: Eyes. Lips. Face. And we are loving their fabulous, zero-guilt, 100% vegan products. </p>
</div>
