...
<head>
    <meta charset="utf-8">
    <title> Huda Beauty Products </title>
...
<div style="text-align: center; font-weight: bold; margin-top: 50px; font-size: 25px; color: darkred; "> Huda Beauty (<?php echo mysqli_num_rows($res);?>) </div>
</div>
...
<?php // product list  ?>
    ...
    $query = "Select *from product where title like '%$search%' or description like '%$search%' or ingredients like '%$search%' or category like '%$search%' ";
    $res = mysqli_query($conn,$query);

    ?>
<div style="text-align: center; font-weight: bold; margin-top: 90px; font-size: 1.5vw; color: white; background-color:black; padding: 10px; width: 100%" > All products(<?php echo mysqli_num_rows($res);?>) </div> 
