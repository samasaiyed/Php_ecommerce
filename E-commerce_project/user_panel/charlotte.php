...
$sql = "select *from product where brand = 'CHARLOTTE TILBURY' && status = 1";
...
<div style="text-align: center; font-weight: bold; margin-top: 50px; font-size: 25px; color: darkred; "> Charlotte Tilbury(<?php echo mysqli_num_rows($res);?>) </div>
</div>
