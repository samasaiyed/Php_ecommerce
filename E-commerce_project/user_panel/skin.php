...
$sql = "select *from product where category = 'Skin'";
...
<div class="brand-name"  style="margin-top: 8vw;">
<div style="text-align: center; font-weight: bold; margin-top: 5vw; font-size:2vw ; color: darkred; "> Skin Care(<?php echo mysqli_num_rows($res);?>) </div>
</div>
...
<div class="text" style="margin-top: 2vw;"> All Products </div>
</div>
<?php // product list  ?>
<div class="container"> 
<div class="row"> 
