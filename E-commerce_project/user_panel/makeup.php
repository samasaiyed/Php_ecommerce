...
$sql = "select *from product where category = 'Makeup'";
...
<div style="text-align: center; font-weight: bold; margin-top: 50px; font-size: 25px; color: darkred; "> MakeUP Collection(<?php echo mysqli_num_rows($res);?>) </div>
</div>
