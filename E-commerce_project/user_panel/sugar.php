...
$sql = "select *from product where brand = 'SUGAR' && status = 1";
...
<div style="text-align: center; font-weight: bold; margin-top: 50px; font-size: 25px; color: darkred; "> SUGAR(<?php echo mysqli_num_rows($res);?>) </div>
</div>

<div class="slide" align="center">
                <img src="image/sugar/sugar_slide.jpg">
                <img src="image/sugar/sugar_slide1.jpg">
</div> 
