...
$sql = "select *from product where brand = 'M.A.C' && status = 1";
...
<div style="text-align: center; font-weight: bold; margin-top: 50px; font-size: 25px; color: darkred; "> M.A.C. Cosmatics(<?php echo mysqli_num_rows($res);?>) </div>
</div>

<div class="slide" align="center">
                <img src="image/mac/mac_slide.jpg">
</div> 
