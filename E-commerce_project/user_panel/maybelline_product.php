...
$sql = "select *from product where brand = 'MAYBELLINE' && status = 1";
...
<div style="text-align: center; font-weight: bold; margin-top: 50px; font-size: 25px; color: darkred; "> Maybelline(<?php echo mysqli_num_rows($res);?>) </div>
</div>

<div class="slide" align="center">
                <img src="image/maybelline/maybelline_slide.jpg">
                <img src="image/maybelline/maybelline_slide1.jpg">
                <img src="image/maybelline/maybelline_slide2.jpg">
</div> 
