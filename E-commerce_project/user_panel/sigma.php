...
$sql = "select *from product where brand = 'SIGMA' && status = 1";
...
<div style="text-align: center; font-weight: bold; margin-top: 50px; font-size: 25px; color: darkred; "> SIGMA(<?php echo mysqli_num_rows($res);?>) </div>
</div>
