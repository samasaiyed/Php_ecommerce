...
?> 
	<section class="section3">
		<div class="user" align="center"> <a href="dashboard.php"> Back </a> ORDER DETAILS </div>
		<div> 
			<div class="card">
						...
						<tr>
							...
							<td>
								<table border="1" align="center" style="background-color: lavender; width: 100%;">
										...
										<?php
										$result1 = mysqli_query($conn,"SELECT * FROM order_master WHERE order_id = '".$row["oid"]."' and status='confirm'");
